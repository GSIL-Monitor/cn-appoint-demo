 ...
 */
@Component
public class SubmitVenderOrderJob implements SimpleJob {
    private final Logger logger = LoggerFactory.getLogger(SubmitVenderOrderJob.class);
    ...
    public void execute(ShardingContext shardingContext) {
        try {
            tasksAppointFacade.submitVenderOrder();
        } catch (Exception exc) {
